...
pub-info:
  links:
    ...
    - name: Add to Zotero
      url: https://www.zotero.org/save?type=doi&q=10.2139/ssrn.5589490
      icon: ai ai-zotero
  reference: >-
...
doi: https://dx.doi.org/10.2139/ssrn.5589490
haiku: 
...
<a class="btn btn-danger" target="_blank" href="https://www.zotero.org/save?type=doi&q=10.2139/ssrn.5589490">{{< ai zotero >}}&emsp;Add to Zotero {{< fa square-arrow-up-right >}}</a>
</p>

```bibtex
@article{CeballosConchaEtAl_SSRN_2025,
  author  = {Adams Ceballos-Concha and Frank Asche and Andrew Ropicki and Conner Mullally and Jordan Moor},
  title   = {Matching Property Rights and Transboundary Ecological Processes: The Case of Norwegian Salmon Aquaculture},
  journal = {American Journal of Agricultural Economics (Forthcoming)},
  year    = {2025},
  doi     = {10.2139/ssrn.5589490},
  url     = {https://dx.doi.org/10.2139/ssrn.5589490}
}
```